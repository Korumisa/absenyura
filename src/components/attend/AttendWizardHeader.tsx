            ...
            <li key={step.id} className="flex flex-1 flex-col items-center gap-1">
              <div
                className={cn(
                  ...
                  !done &&
                    !active &&
                    'border-border bg-slate-50 text-slate-400 dark:border-zinc-600 bg-muted'
                )}
              ...
              <span
                className={cn(
                  'text-center text-[11px] font-semibold sm:text-xs',
                  active ? 'text-brand text-brand' : 'text-muted-foreground'
                )}
              >
