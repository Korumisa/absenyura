    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Siapkan izin berikut agar check-in lancar:</p>
        </div>
        <Button
          type="button"
          variant="ghost"
      ...
      <ul className="mt-4 space-y-2 text-sm text-foreground">
        <li className="flex items-start gap-2">
          <Camera className="mt-0.5 h-4 w-4 shrink-0 text-brand" aria-hidden="true" />
        ...
        <li className="flex items-start gap-2">
          <Wifi className="mt-0.5 h-4 w-4 shrink-0 text-brand" aria-hidden="true" />
