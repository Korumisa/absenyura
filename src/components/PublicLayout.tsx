    ...
    >
      ...
      {showChat && waUrl ? (
        <a
          ...
          className="fixed bottom-4 right-4 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[var(--public-primary)] text-white shadow-[0_14px_30px_rgba(37,99,235,0.35)] ring-1 ring-black/10 transition hover:brightness-110 dark:ring-white/10 sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
        >
