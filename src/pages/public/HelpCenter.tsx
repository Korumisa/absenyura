        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-xl md:text-2xl leading-relaxed text-white/60 font-light">
              Akses perpustakaan lengkap kami yang berisi panduan penerapan, ikhtisar arsitektural, dan protokol pemecahan masalah. Dokumentasi kami dikelola secara langsung oleh para insinyur yang membangun platform ini, menjamin akurasi informasi.
            </p>
          </div>
