        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-xl md:text-2xl leading-relaxed text-white/60 font-light">
              Spesifikasi endpoint yang terperinci, alur autentikasi JWT, dan skema data JSON. Bangun integrasi yang tangguh menggunakan definisi OpenAPI kami yang terstandarisasi serta SDK khusus untuk berbagai bahasa pemrograman modern.
            </p>
          </div>
