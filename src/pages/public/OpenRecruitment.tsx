      ...
      {selected ? (
        ...
        <div className="fixed inset-0 z-[60] flex items-end justify-center p-3 sm:items-center sm:p-6">
          ...
          <div
            role="dialog"
            aria-modal="true"
            className="relative flex w-full max-w-2xl max-h-[92vh] flex-col overflow-hidden rounded-2xl border border-black/10 bg-white shadow-[0_30px_80px_-45px_rgba(15,23,42,0.55)] dark:border-white/10 dark:bg-zinc-950 dark:shadow-[0_30px_80px_-45px_rgba(0,0,0,0.7)]"
          >
            <div className="aspect-[16/9] w-full shrink-0 bg-[linear-gradient(135deg,rgba(37,99,235,0.18),rgba(15,23,42,0.03))] dark:bg-[linear-gradient(135deg,rgba(37,99,235,0.2),rgba(255,255,255,0.04))]">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              {selected.description ? <div className="text-sm leading-relaxed text-slate-700 dark:text-slate-200">{selected.description}</div> : null}
